...
\begin{figure}[H]
    ...
    \caption{Thống kê số lượng tài khoản ban đầu và sau khi lọc nút cô lập}
...
Kết quả thống kê số lượng cạnh sau khi đã thực hiện tạo cạnh đối xứng cho các quan hệ có hướng được trình bày tại \textbf{Hình \ref{fig:MultiLayerEdges}}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{images/part-02/chap-02/sec-02/MultiLayerEdgesDistribution.png}
    \caption{Phân bổ số lượng cạnh của bốn tầng trên các phạm vi thời gian}
...
Chất lượng dữ liệu định danh đóng vai trò quyết định đến hiệu quả của quá trình nhúng ngữ nghĩa. Đề tài thực hiện đánh giá hai chỉ số then chốt: Tỷ lệ lấp đầy và Độ dài văn bản trung bình trên ba trường dữ liệu: \texttt{handle}, \texttt{display\_name} và \texttt{bio}.
...
Bằng cách kết hợp các trường dữ liệu, độ dài chuỗi đầu vào cho mô hình nhúng ngữ nghĩa được duy trì ổn định ở mức xấp xỉ 35 ký tự (Ví dụ phạm vi Quý đạt 36.3 ký tự, trong đó đóng góp từ \texttt{bio} là 19.4). Việc duy trì một đặc trưng hồ sơ cá nhân đủ dày giúp mô hình \textit{all-MiniLM-L6-v2} có thể trích xuất các vector đặc trưng có độ phân tách cao, ngay cả đối với các nút có thuộc tính mô tả bị khuyết thiếu.\vspace{0.3cm}
