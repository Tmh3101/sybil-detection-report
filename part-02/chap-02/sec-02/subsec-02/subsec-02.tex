...
\textit{2.3.1. Trích xuất đặc trưng tiềm ẩn và gom cụm hành vi}\vspace{0.2cm}

Quy trình bắt đầu bằng việc sử dụng mô hình GAE \cite{kipf2016variational} để nén không gian đặc trưng hỗn hợp 396 chiều xuống không gian nhỏ hơn. Khác với các phương pháp giảm chiều thông thường, GAE bảo toàn đồng thời cả đặc trưng nút và cấu trúc liên kết đa tầng của đồ thị.\vspace{0.3cm}

Tiếp theo, thuật toán K-Means được áp dụng trên các vector embeddings để xác định các phân vùng hành vi tương đồng. Các cụm này sau đó được ánh xạ và hợp nhất thành 04 loại nhãn dựa trên hệ thống luật tối ưu:
...
\begin{figure}[H]
    ...
    \caption{Sự tăng trưởng và lộ diện của các nhóm nhãn qua các phạm vi thời gian}
    \label{fig:LabelDist}
\end{figure}
