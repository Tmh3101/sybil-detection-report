...
\begin{itemize}[label={--}, itemsep=1pt]
    ...
    \item \textbf{Đặc trưng cấu trúc mạng lưới:} Đây là luồng thông tin đóng vai trò then chốt, biểu diễn mối liên kết giữa các tài khoản dưới dạng đồ thị đa quan hệ có trọng số. Cấu trúc này không chỉ bao gồm các hành vi tương tác trên mạng xã hội (theo dõi và tương tác), mà còn khai thác tính sở hữu trong mạng xã hội Web3 để nhận diện các cụm ví bị điều khiển bởi cùng một thực thể \cite{liu2025detecting}. Bằng việc tích hợp thêm tầng tương đồng (similarity layer) để liên kết các tài khoản có sự rập khuôn về tiểu sử hoặc thời gian khởi tạo, mô hình có khả năng bóc trần toàn diện các "cạnh tấn công" ẩn nấp phía sau các tương tác trông có vẻ hợp lệ \cite{heeb2024sybil}.
\end{itemize}

Mục tiêu cốt lõi của bài toán là vượt qua giới hạn của việc thiếu nhãn dữ liệu thông qua quy trình học không giám sát (GAE kết hợp K-Means) và xây dựng kiến trúc hợp nhất dựa trên Mạng nơ-ron đồ thị (GNN) kết hợp Máy học truyền thống (Decoupled ML). Kiến trúc này đóng vai trò nhúng các đặc trưng đa chiều và cấu trúc mạng lưới vào một không gian chung, nhằm tối ưu hóa độ chính xác phân lớp rủi ro và cung cấp khả năng giải thích cho các quyết định ngăn chặn Sybil.
