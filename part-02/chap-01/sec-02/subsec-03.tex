...
\begin{itemize}[label={--}, itemsep=5pt]
    ...
    \begin{itemize}[label={+}, itemsep=2pt]
        ...
        \item Mô hình tích hợp \textbf{\textit{Multi-head Attention}} tương tự Transformer \cite{vaswani2017attention} để ổn định quá trình học, thực hiện ghép nối ở tầng ẩn và lấy trung bình ở tầng đầu ra.
    \end{itemize}
