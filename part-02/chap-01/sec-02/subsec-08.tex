...
\indent\indent Trong bài toán hiện tại, dữ liệu thực tế luôn tồn tại sự chênh lệch rất lớn. Do bài toán được thiết lập dưới dạng phân loại đa lớp với $C=4$ nhãn, việc chỉ dựa vào tỷ lệ dự đoán đúng là không đủ để đánh giá toàn diện. Hệ thống đánh giá trong nghiên cứu này được xây dựng dựa trên Ma trận nhầm lẫn đa lớp (\textit{Multi-class Confusion Matrix}). Kế thừa hệ thống thang đo của Sokolova và Lapalme \cite{sokolova2009systematic}, đề tài thiết lập các tiêu chuẩn đánh giá theo chiến lược \textit{một chống lại tất cả} cho từng lớp $i$ như sau:
