...
\begin{table}[H]
    ...
    \begin{tabular}{|p{3.2cm}|p{3.5cm}|c|p{6.6cm}|}
        ...
        \hline
        Tương tác xã hội thấp & \texttt{pct\_social} $\leq 20\%$ & $+10$ & \textbf{Đề xuất của nghiên cứu:} Phản ánh đặc tính của Sybil sinh ra chỉ để trục lợi. \\
        \hline
