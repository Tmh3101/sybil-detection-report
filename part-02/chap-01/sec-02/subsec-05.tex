...
Áp dụng nguyên lý này vào bài toán hiện tại, hệ thống thiết lập giả thuyết rằng các mạng lưới Sybil thường hoạt động thành các nhóm nhỏ (whiskers). Dựa trên quy mô $N$ của từng tập dữ liệu, không gian tìm kiếm tham số $K$ tối ưu được hệ thống ước lượng trước thông qua công thức định hướng:
\begin{equation}
...
\begin{table}[H]
    ...
    \begin{tabular}{p{3cm} p{3.5cm} c p{6.4cm}}
        ...
        \midrule
        Độ tương đồng hành vi & \texttt{pct\_similarity} $\geq 50\%$ & $+30$ & \textbf{Đề xuất của nghiên cứu:} Phản ánh các kịch bản tương tác rập khuôn của mạng lưới lính ảo được cấu hình sẵn. \\
...
Tổng điểm rủi ro của một cụm $C$ được tổng hợp từ các lỗi vi phạm và tính toán thông qua hàm giới hạn trần để đảm bảo điểm không vượt quá ngưỡng tối đa:\vspace{-0.1cm}
\[
